            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('/posts/create') }}">Create a New Post</a>
                        <a class="collapse-item" href="{{ url('/posts') }}">View All Posts</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('/categories/create') }}">Create New Category</a>
                        <a class="collapse-item" href="{{ url('/categories') }}">View All Categories</a>
                    </div>
                </div>
            </li>
